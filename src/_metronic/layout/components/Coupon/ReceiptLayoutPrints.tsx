    ...
    <div className='' style={{width: '1240px'}}>
      ...
      <div className='row fs-4 border border-dark'>
          ...
          <div className='col-3 text-center fw-bold border-start border-dark p-0'>
            ...
            <div>
              ...
              <div className='d-flex barcodeCSS'>
                <Barcode value={`A24MDM.91.3-5377-DH${data?.indexRow}`} displayValue={false} />
              </div>
        ...
        <div className='row border-start border-end border-bottom border-dark'>
          <div className='col-5 fs-4 border-end border-dark'>
            ...
            <div>
              ...
              <p className='mb-1 d-flex'>
                ...
                <span>{`${data?.receiverAddress}, ${data?.receiverCommune?.name}, ${data?.receiverDistrict?.name}, ${data?.receiverProvince?.name}`}</span>
              </p>
            </div>
          </div>
          <div className='col-7 fs-4 p-0'>
                ...
                <div className='row'>
                  <div className='col-7'>
                    ...
                    <p className='mb-1 d-flex'>
                      ...
                      <span style={{width: 'calc(100% - 200px)'}}>
                        {data?.itemWeight?.toLocaleString()}
                      </span>
                      <span>Kg</span>
                    </p>
                    <p className='mb-1 d-flex'>
                      ...
                      <span>{data?.itemQuantity?.toLocaleString()}</span>
                    </p>
                    <p className='mb-1 d-flex'>
                      <p className='m-0' style={{width: '150px'}}>
                        e. Phân tuyến:
                      </p>
                      <span>{data?.receiverCommune?.shipmentType.toLocaleString()}</span>
                    </p>
                  </div>
                  <div className='col-5'>
                    <p>
                      (Trường hợp nơi nhận thuộc khu vực huyện xã sẽ cộng thêm 25% vào giá dịch vụ
                      vận chuyển)
                    </p>
                  </div>
                </div>
            ...
            <div className='border-bottom border-dark'>
              ...
              <div className='container px-3'>
                <div className='row'>
                  <div className='col'>
                    <p className='mb-1 d-flex'>
                      <p className='m-0' style={{width: '400px'}}>
                        a. Giá dịch vụ khai giá trị hàng hóa:
                      </p>
                      <span style={{width: 'calc(100% - 240px)'}}>
                        {data?.itemValue?.toLocaleString()}
                      </span>
                      <span>đồng</span>
                    </p>
                    ...
                    <p className='mb-1 d-flex'>
                      <p className='m-0' style={{width: '400px'}}>
                        b. Giá dịch vụ đóng gói:
                      </p>
                      <span style={{width: 'calc(100% - 240px)'}}>
                        {data?.packagingServiceFee?.toLocaleString()}
                      </span>
                      <span>đồng</span>
                    </p>
                    <p className='mb-1 d-flex'>
                      <p className='m-0' style={{width: '400px'}}>
                        c. Giá dịch vụ vận chuyển:
                      </p>
                      <span style={{width: 'calc(100% - 240px)'}}>
            ...
            <p className='fw-bold border-dark px-3 m-0 d-flex h-50px align-items-center'>
              <p className='m-0' style={{width: '200px'}}>
                3. Người gửi thanh toán:
              </p>
              <span className='fs-1' style={{width: 'calc(100% - 250px)'}}>
                {data?.totalAmount?.toLocaleString()}
              </span>
              <span>đồng</span>
            </p>
        ...
        <div className='row'>
              ...
              <div className='row h-100'>
                <div className='col-8 border-end border-dark h-100'>
                  <p className='mb-0 fst-italic text-center'>
                    Tôi đã đọc và đồng ý với các nội dung được ghi trên cả 2 mặt của Phiếu nhận hàng
                    này
                  </p>
          ...
          <div
            className='col-7 border-end border-bottom border-dark'
        ...
        <div className='row border-start border-end border-bottom border-dark'>
          <span className='py-2 fst-italic fw-bold text-center'>
            Khi có khiếu nại hoặc đến nhận tiền thu hộ (COD), Quý khách vui lòng mang theo Phiếu gửi
            hàng này và xuất trình các giấy tờ có liên quan
          </span>
        </div>
      </div>
      ...
      <div className='row fs-4 border border-dark'>
          ...
          <div className='col-7 text-center pt-3'>
            ...
            <p className='fst-italic fs-5 m-0'>(Liên 2: Giao cho khách hàng)</p>
            <div className='container'>
              <div className='row'>
                <div className='col-6 text-start'>
                  <p className='m-0'>
      ...
      <div className='container' style={{width: '1240px'}} ref={reportTemplateRef3}>
        <div className='row fs-4 border border-dark'>
          <div className='col-2 pt-3'>
            <img src={toAbsoluteUrl('/media/logos/logo-new.png')} alt='Logo' className='w-100' />
          </div>
          <div className='col-7 text-center pt-3'>
            ...
            <p className='fst-italic fs-5 m-0'>(Liên 3: Giao cho khách hàng)</p>
            <div className='container'>
              <div className='row'>
                <div className='col-6 text-start'>
                  <p className='m-0'>
