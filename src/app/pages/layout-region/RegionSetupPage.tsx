...
const RegionSetupPage = (props: Props) => {
  ...
  const {gridRefRegionSetup, listRegions, setListRegions, showModalRegion, setShowModalRegion, setDataModalRegion} = usePageData();
  ...
  return (
    <div style={containerStyle}>
      ...
      <CreateAppModal
        ...
        content={<ModalShowAndAddRegion title={intl.formatMessage({id: 'MENU.KHUVUC'})} refreshData={getListRegions} handleClose={handleCloseModalRegion}/>}
